...
Cortex Mining Hub `dev-0.1.4` is a first-party Cortex recipe. The store
ships listing metadata and Compose only. The node pulls the portal image
from GitHub Container Registry.

- **Cortex Mining Hub `dev-0.1.4`** — source-available first-party portal
  - Source: https://github.com/cortex-repo/cortex-mining
  - Image: `ghcr.io/cortex-repo/cortex-mining-hub:dev-0.1.4`
