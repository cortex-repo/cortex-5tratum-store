...
Cortex Trading `dev-0.1.14` is a first-party Cortex recipe. The store ships
listing metadata and Compose only. The node pulls the portal+worker image
from GitHub Container Registry.

- **Cortex Trading `dev-0.1.14`** — source-available first-party agent
  - Source: https://github.com/cortex-repo/cortex-trading
  - Image: `ghcr.io/cortex-repo/cortex-trading:dev-0.1.14`
