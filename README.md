...
| [Cortex Trading](./cortex-trading/) | `dev-0.1.4` | eToro Demo/LIVE agent with RiskGate and ops dashboard | `ghcr.io/cortex-repo/cortex-trading` · [cortex-trading](https://github.com/cortex-repo/cortex-trading) |
