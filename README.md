...
| [Cortex Monitoring](./cortex-monitoring/) | `dev-0.0.18` | Observability stack portal (Grafana, VictoriaMetrics/Logs, Alloy, Axe BCH pool logs, …) | `ghcr.io/cortex-repo/cortex-monitoring` · [cortex-monitoring](https://github.com/cortex-repo/cortex-monitoring) |
