...
|-----|---------|---------|----------------|
| [Cortex Mining Hub](./cortex-mining-hub/) | `dev-0.1.4` | Fleet portal for Axe nodes, LAN miners, and 5tratumOS KPIs | `ghcr.io/cortex-repo/cortex-mining-hub` · [cortex-mining](https://github.com/cortex-repo/cortex-mining) |
